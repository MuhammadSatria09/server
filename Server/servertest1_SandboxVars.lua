SandboxVars = {
    ...
    AutoEngineering = {
        NeedsWreckRecipe = true,
        NeedsRepairMaterials = true,
        -- Minimum=0 Maximum=10 Default=7
        EngineMechanicsLvl = 7,
        -- Minimum=0 Maximum=10 Default=5
        RepairMechanicsLvl = 5,
        -- Minimum=0 Maximum=10 Default=3
        RepairWeldingLvl = 3,
        -- Minimum=0 Maximum=10 Default=1
        RepairElectricityLvl = 1,
        -- Minimum=0 Maximum=999 Default=10
        RepairFuel = 10,
        -- Minimum=0 Maximum=999 Default=10
        RepairEngineParts = 10,
        -- Minimum=0 Maximum=999 Default=5
        RepairSheetMetal = 5,
        -- Minimum=0 Maximum=999 Default=10
        RepairScrapMetal = 10,
        -- Minimum=0 Maximum=999 Default=10
        RepairElectronicsScrap = 10,
    },
    Camouflage = {
